...
class SEImageClipScrollView: UIView {
    ...
    /// 负责处理裁剪框大小
    private var clipResizeView: SEImageClipResizeView?
...
extension SEImageClipScrollView {
    ...
    private func setupClipResizeView() {
        let clipResizeView = SEImageClipResizeView(frame: scrollView.frame, contentSize: contentSize, margin: margin, scrollView: scrollView, imageView: imageView)
        clipResizeView.canRecoveryClosure = canRecoveryClosure
        clipResizeView.prepareToScaleClosure = prepareToScaleClosure
...
extension SEImageClipScrollView: UIScrollViewDelegate {
